#ifndef UTILS_FILTER_KALMEN_FILTER_H_
#define UTILS_FILTER_KALMEN_FILTER_H_
...
inline void KalmanFilter<T, XN, ZN, UN>::Correct(
  ...
  K_ = static_cast<Eigen::Matrix<T, XN, ZN>>(P_ * H_.transpose() * (S_.inverse()));
...
#endif // UTILS_FILTER_KALMEN_FILTER_H_